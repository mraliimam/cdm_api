...
class AAIAPUSERS(db.Model):
    ...
    USER_STAGE = db.Column(db.String(1), nullable=True)
    ...
    PAYMENT_RATIO =  db.Column(db.Integer, nullable=True)
    ...
    _DEFAULT_CAPACITY: dict = {'effort': 30.0, 'limit': 200.0, 'accuracy': 0.75, 'skill': 'intermediate', 'exp': 1}

    def _stage_defaults(self) -> dict:
        """Return capacity defaults derived from USER_STAGE when CDM columns are NULL."""
